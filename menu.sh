...
echo -e "  \e[$number (•2)\e[m \e[$below XRAY VMESS & VLESS\e[m"
echo -e "  \e[$number (•3)\e[m \e[$below TROJAN XRAY & WS\e[m"
echo -e " \e[$line╒════════════════════════════════════════════════════════════╕\e[m"
...
echo -e "  \e[$number (•5)\e[m \e[$below CHECK RUNNING\e[m        \e[$number (•9)\e[m \e[$below REGIP ADMIN ONLY\e[m"
...
echo -e "  \e[$below Autoscript By        : NAKATAVPN"
